...
.directive('simpleDropdown', function() {
  return {
    ...
    link: function(scope, element, attrs, DropDownController) {
      scope.dropdown_class = 'ui dropdown';
      ...
      element.bind('click', function() {
        if (scope.is_open === false) {
          scope.$apply(function() {
            scope.dropdown_class = 'ui dropdown active visible';
...
.directive('downloadDropdown', function() {
  return {
    restrict: 'E',
    replace: true,
    transclude: true,
    ...
    template: '<button class="{{ dropdown_class }}">' +
      '<div class="{{text_class}}">' + 
      ...
      '</button>',
    link: function(scope, element, attrs, DropDownController) {
      scope.dropdown_class = 'ui dropdown small right floated basic button';
      scope.menu_class = 'menu transition hidden';
      scope.text_class = 'text';
      scope.original_title = scope.title;
      ...
      element.bind('click', function() {
        if (scope.is_open === false) {
          scope.$apply(function() {
            scope.dropdown_class = 'ui dropdown small right floated basic button active visible';
            scope.menu_class = 'menu transition visible';
          });
        } else {
          scope.$apply(function() {
...
.directive('simpleDropdownGroup', function() {
  return {
    restrict: 'AE',
    replace: true,
    transclude: true,
    ...
    link: function(scope, element, attrs, DropDownController) {
      ...
      element.bind('click', function() {
        ...
        //Make event specific to the download. e.g. XLS, JSON, Share
...
.directive('downloadDropdownGroup', function() {
  return {
    restrict: 'AE',
    replace: true,
    transclude: true,
    require: '^downloadDropdown',
    scope: {
      title: '=title',
      value: '=value'
    },
