		...
		getData: function(){
			...
			return [
			{
				meta: {
						...
						category: "Economy",
						modified: "23w ago",
						description: "Total inward and outward traffic from Northern Ireland ports 1998-2015.",
			...
			
			{
				meta: {
					...
					category: "Economy",
					modified: "23w ago",
					description: "Air passenger flown in Northern Ireland from 2005-2016.",
					dataTypes: ["JSON", "CSV", "Excel"],
		    ...
		    },
		    {
				meta: {
					...
					category: "Economy",
					modified: "15w ago",
					description: "Unemployment by year from 1985-2016.",
					dataTypes: ["JSON", "CSV", "Excel"],
					dataComponents: ["Overall population", "Male population", "Female population"],
					labelKeyName: "Year",
			...
			},
			{
				meta: {
					...
					category: "Social",
					modified: "23w ago",
					description: "% achieving A*-C Grades at GCSE and A-level from 2008-2016.",
					dataTypes: ["JSON", "CSV", "Excel"],
					dataComponents: ["Blah I am an error. Tell Chris."],
			...
			},
			{
				meta: {
					...
					category: "Social",
					modified: "23w ago",
					description: "Crime by type from 1998-2016.",
					dataTypes: ["JSON", "CSV", "Excel"],
					dataComponents: ["Blah I am an error. Tell Chris."],
					publisher: "PSNI",
					publishFrequency: "1st Monday each month",
			...
			},
			{
				meta: {
					...
					category: "Social",
					modified: "23w ago",
					description: "Planning applications from 2003-2016",
					dataTypes: ["JSON", "CSV", "Excel"],
					dataComponents: ["Blah I am an error. Tell Chris."],
					publisher: "Department for Communities",
					publishFrequency: "1st Monday each month",
